...
//   {
//     title: 'event 1',
//     start: '2025-10-10T01:00:00',
//     end: '2025-10-11T02:00:00'
//   }
// ]
  ...
  const handleEventClick = (info) => {
    ...
    setValue("patient", info.event.extentedProps.patient);
    setValue("doctor", info.event.extentedProps.doctor);
    setValue("startTime", info.event.extentedProps.startTime);
    setValue("endTime", info.event.extentedProps.endTime);
    setOpen(true);
  };
